...
var toHtmlFile = function(urlFile, checks) {
               
   fs.writeFileSync(htmlFile, urlFile);
   return checkHtmlFile(htmlFile, checks);
...
if(require.main == module) {
    ...
    rest.get(program.url).on('complete', function(result) {
        var checkUrlJson = toHtmlFile(result, program.checks);
